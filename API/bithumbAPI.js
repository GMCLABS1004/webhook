...
function BithumAPI(api_key, api_secret){
	this.apiUrl = 'https://api.bithumb.com';
	this.api_key = api_key;
	this.api_secret = api_secret;
}

module.exports= BithumAPI;

BithumAPI.prototype.bithumPostAPICall = function(endPoint, params,callback) {
	var rgParams = {
		'endPoint' : endPoint
	};
 ...
 */
BithumAPI.prototype.orderbook = function(currency, callback){
    //1.빗썸 매수/매도 값 조회
    var options = {
        method : "GET",
...
/**
 * 
 * @param {String} currency : "BTC" || "ALL"
 * @param {function} callback error, response, body
 */
BithumAPI.prototype.ticker = function(currency, callback){
    //1.빗썸 매수/매도 값 조회
    var options = {
        method : "GET",
...
BithumAPI.prototype.request = function(strHost, strMethod, rgParams, httpHeaders) {
...
BithumAPI.prototype._getHttpHeaders = function(endPoint, rgParams, api_key, api_secret) {
	var strData	= http_build_query(rgParams);
	//var nNonce = this.usecTime();
	var nNonce = new Date().getTime();
	return {
		'Api-Key' : api_key,
...
BithumAPI.prototype.usecTime = function(){
